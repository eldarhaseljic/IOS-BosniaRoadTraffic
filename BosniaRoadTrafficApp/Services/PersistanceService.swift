...
//
//  Used from: https://stackoverflow.com/questions/39348729/core-data-viewcontext-not-receiving-updates-from-newbackgroundcontext-with-nsf
...
class PersistanceService {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "BosniaRoadTrafficApp")
